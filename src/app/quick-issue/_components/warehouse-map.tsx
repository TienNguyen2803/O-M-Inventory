                ...
                return (
                  <button
                    ...
                    className={cn(
                      ...
                      isHighlighted && 'bg-blue-100 border-blue-400 text-blue-900 hover:bg-blue-200 cursor-pointer disabled:opacity-70 disabled:hover:bg-blue-100',
                      !isHighlighted && 'opacity-50 cursor-not-allowed'
                    )}
                  >
                    {loc.code}
                  </button>
